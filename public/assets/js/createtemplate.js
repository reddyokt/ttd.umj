$(function(){
    $(document).on("submit", "#form_add_template", function(e) {
        var url = "/master/template/store";
                        ...
                        success: function(data) {
                            if (data.status) {
                                Swal.fire({
                                    ...
                                    window.location.replace("/master/template/index");
                                });
                            } else {
                                Swal.fire({
    ...
    $(document).on("submit", "#form_edit_template", function(e) {
        var id = $('#id').val();
        var url = "/master/template/update/"+id;
        var form_data =new FormData($(this)[0]);
