                ...
                <table class="table table-row-dashed align-middle gs-0 gy-3 my-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-start pe-0">
                                <span class="text-gray-600 fw-bold fs-9">
                                    <small>
                                        ...
                                        <br>
                                        Klasifikasi : {{ $dt->klasifikasi->nama_klasifikasi}}
                                    </small>
                                </span>
                                <span class="p-10">
                                    <a href="#" class="btn btn-sm btn-icon btn-bg-white btn-active-color-success w-20px h-20px" style="margin-right: 10px" data-bs-toggle="modal" data-bs-target="#kt_modal_detail-{{ $dt->id_ajuan }}">
                            ...
                            <td class="text-start pe-0">
                                <!--begin::Label-->
                                <span class="badge badge-light-{{ $dt->status == 'Menunggu' ? 'warning' : ($dt->status== 'Ditolak' ? 'danger' : 'success') }} fs-8">
                                <!--begin::Svg Icon | path: icons/duotune/arrows/arr066.svg-->
                                <span class="svg-icon svg-icon-5 svg-icon-{{ $dt->status == 'Menunggu' ? 'warning' : ($dt->status== 'Ditolak' ? 'danger' : 'success') }} ">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <td class="text-start g-1">
                                ...
                                <a href="#" class="btn btn-sm btn-icon btn-bg-light btn-active-color-danger w-20px h-20px">
                                    <!--begin::Svg Icon | path: /var/www/preview.keenthemes.com/kt-products/docs/metronic/html/releases/2023-01-30-131017/core/html/src/media/icons/duotune/arrows/arr046.svg-->
            ...
            <!--begin::Table container-->
                <div class="table-responsive">
                    ...
                    <table class="table table-row-dashed align-middle gs-0 gy-3 my-0">
                        ...
                        <!--begin::Table body-->
                        <tbody>
                            @foreach ($dataPemohon as $dtp )
                            <tr>
                                <td class="text-start pe-0">
                                    <span class="text-gray-600 fw-bold fs-8">00{{ $dtp->id_ajuan }}</span>
                                </td>
                                <td class="text-start pe-0">
                                    <span class="text-gray-600 fw-bold fs-9">
                                        <small>
                                            Nomor Surat/Dokumen : {{ $dtp->nomor_surat }}
                                            <br>
                                            Klasifikasi : {{ $dtp->klasifikasi->nama_klasifikasi}}
                                        </small>
                                    </span>
                                    <span class="p-10">
                                        <a href="#" class="btn btn-sm btn-icon btn-bg-white btn-active-color-success w-20px h-20px" style="margin-right: 10px" data-bs-toggle="modal" data-bs-target="#kt_modal_detail-{{ $dtp->id_ajuan }}">
                                            <span class="svg-icon svg-icon svg-icon-2hx">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M21.7 18.9L18.6 15.8C17.9 16.9 16.9 17.9 15.8 18.6L18.9 21.7C19.3 22.1 19.9 22.1 20.3 21.7L21.7 20.3C22.1 19.9 22.1 19.3 21.7 18.9Z" fill="currentColor"/>
                                                    <path opacity="0.3" d="M11 20C6 20 2 16 2 11C2 6 6 2 11 2C16 2 20 6 20 11C20 16 16 20 11 20ZM11 4C7.1 4 4 7.1 4 11C4 14.9 7.1 18 11 18C14.9 18 18 14.9 18 11C18 7.1 14.9 4 11 4ZM8 11C8 9.3 9.3 8 11 8C11.6 8 12 7.6 12 7C12 6.4 11.6 6 11 6C8.2 6 6 8.2 6 11C6 11.6 6.4 12 7 12C7.6 12 8 11.6 8 11Z" fill="currentColor"/>
                                ...
                                <td class="text-start pe-0">
                                    <!--begin::Label-->
                                    <span class="badge badge-light-{{ $dtp->status == 'Menunggu' ? 'warning' : ($dtp->status== 'Ditolak' ? 'danger' : 'success') }} fs-8">
                                    <!--begin::Svg Icon | path: icons/duotune/arrows/arr066.svg-->
                                    <span class="svg-icon svg-icon-5 svg-icon-{{ $dtp->status == 'Menunggu' ? 'warning' : ($dtp->status== 'Ditolak' ? 'danger' : 'success') }} ">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <rect opacity="0.5" x="13" y="6" width="13" height="2" rx="1" transform="rotate(90 13 6)" fill="currentColor" />
                                            <path d="M12.5657 8.56569L16.75 12.75C17.1642 13.1642 17.8358 13.1642 18.25 12.75C18.6642 12.3358 18.6642 11.6642 18.25 11.25L12.7071 5.70711C12.3166 5.31658 11.6834 5.31658 11.2929 5.70711L5.75 11.25C5.33579 11.6642 5.33579 12.3358 5.75 12.75C6.16421 13.1642 6.83579 13.1642 7.25 12.75L11.4343 8.56569C11.7467 8.25327 12.2533 8.25327 12.5657 8.56569Z" fill="currentColor" />
                                        </svg>
                                    </span>
                                    <!--end::Svg Icon-->{{ $dtp->status }}</span>
                                    <!--end::Label-->
                                </td>
                                <td class="text-start pe-0">
                                    @if( $dtp->status== 'Diterima')
                                    <div class="visible-print text-start">
                                        <img src="data:image/png;base64, {!! base64_encode(QrCode::format('png')->generate(URL('/show/'.$dtp->id_ajuan.$dtp->token))) !!}" style="width: 50px;">
                                    </div>
                                    @endif
                                </td>
                                <td class="text-start g-1">
                                    <a href="/ajuan/edit/{{ $dtp->id_ajuan }}" class="btn btn-sm btn-icon btn-bg-light btn-active-color-primary w-20px h-20px" style="margin-right: 10px">
                                    ...
                                    <a href="#" class="btn btn-sm btn-icon btn-bg-light btn-active-color-danger w-20px h-20px" style="margin-right: 10px">
...
<div class="modal fade" tabindex="-1" id="kt_modal_detail-{{ $dt->id_ajuan }}">
            ...
            <div class="modal-body">
                <div class="table-responsive">
                    <table class="table gs-2 gy-2 gx-2">
                            ...
                            <tr>
                                <td class="w-50">File </td>
                                <td><a href="{{URL($dt->file_surat)  }}" target="_blank"> Download Here</a></td>
                            </tr>
                    </table>
                </div>
            </div>
...
<div class="modal fade" tabindex="-1" id="kt_modal_detail-{{ $dtp->id_ajuan }}">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title">Detail Surat/Dokumen</h3>
            ...
            <div class="modal-body">
                <div class="table-responsive">
                    <table class="table gs-2 gy-2 gx-2">
                            <tr>
                                <td class="w-50">Klasifikasi Surat</td>
                                <td>{{ $dtp->klasifikasi->nama_klasifikasi }}</td>
                            </tr>
                            <tr>
                                <td class="w-50">Surat Untuk</td>
                                <td>{{ $dtp->tujuan_surat }}</td>
                            </tr>
                            <tr>
                                <td class="w-50">Perihal</td>
                                <td>{{ $dtp->perihal_surat }}</td>
                            </tr>
                            <tr>
                                <td class="w-50">Jenis Surat</td>
                                <td>{{ $dtp->jenis_surat }}</td>
                            </tr>
                            <tr>
                                <td class="w-50">Nomor Surat</td>
                                <td>{{ $dtp->nomor_surat }}</td>
                            </tr>
                            <tr>
                                <td class="w-50">Tanggal Surat</td>
                                <td>{{ $dtp->tanggal_surat }}</td>
                            </tr>
                            <tr>
                                <td class="w-50">File </td>
                                <td><a href="{{URL($dtp->file_surat)  }}" target="_blank"> Download Here</a></td>
                            </tr>
                    </table>
                </div>
            </div>
...
<div class="modal fade modal-xl" tabindex="-1" id="kt_modal_2-{{ $dt->id_ajuan }}">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title">Detail Surat/Dokumen</h3>
            ...
            <div class="modal-body">
                <div class="table-responsive">
                    <form action="/reject/{{ $dt->id_ajuan }}" method="post">
                        @csrf
                    <table class="table gs-2 gy-2 gx-2">
                            <tr>
                                <td class="w-50">Klasifikasi Surat</td>
                            ...
                            <tr>
                                <td class="w-50">Surat Untuk</td>
                                <td class="min-w-250">{{ $dt->tujuan_surat }}</td>
                            </tr>
                            <input type="hidden" name="status" value="Ditolak">
                            <tr>
                                <td class="w-50">Catatan Penolakan/Revisi</td>
                                <td><div class="mb-3">
                                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="revisi"></textarea>
                                  </div>
                                </td>
                            </tr>
                    </table>
