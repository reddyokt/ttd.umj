                ...
                <table class="table table-row-dashed align-middle gs-0 gy-3 my-0">
                    ...
                    <tbody>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex justify-content-start flex-column">
                                        <a href="../../demo1/dist/apps/projects/users.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-8">Darto, S.E., M.M</a>
                                        <span class="text-gray-400 fw-semibold d-block fs-9">Koordinator</span>
                                    </div>
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="text-start pe-0">
                                <span class="text-gray-600 fw-bold fs-8">001/2/2023</span>
                            </td>
                            <td class="text-start pe-0">
                                <span class="text-gray-600 fw-bold fs-8">Pengumuman Pemenang Hibah Internal Penelitian 2022</span>
                            </td>
                            <td class="text-center pe-0">
                                <!--begin::Label-->
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex justify-content-start flex-column">
                                        <a href="../../demo1/dist/apps/projects/users.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-8">Rachma Thalia, S.Pd.</a>
                                        <span class="text-gray-400 fw-semibold d-block fs-9">Staff</span>
                                    </div>
                                </div>
                            </td>
                            <td class="text-start pe-0">
                                <span class="text-gray-600 fw-bold fs-8">002/2/2023</span>
                            </td>
                            <td class="text-start pe-0">
                                <span class="text-gray-600 fw-bold fs-8">Surat Undangan Menjadi Narasumber : Rektor UMJ</span>
                            </td>
                            <td class="text-center pe-0">
                                <!--begin::Label-->
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex justify-content-start flex-column">
                                        <a href="../../demo1/dist/apps/projects/users.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-8">Ratih Widyanti, S.H., M.H</a>
                                        <span class="text-gray-400 fw-semibold d-block fs-9">Staff</span>
                                    </div>
                                </div>
                            </td>
                            <td class="text-start pe-0">
                                <span class="text-gray-600 fw-bold fs-8">003/2/2023</span>
                            </td>
                            <td class="text-start pe-0">
                                <span class="text-gray-600 fw-bold fs-8">Surat Ajuan HKI Dosen </span>
                            </td>
                            <td class="text-center pe-0">
                                <!--begin::Label-->
